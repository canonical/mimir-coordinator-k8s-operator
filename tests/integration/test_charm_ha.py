...
async def test_build_and_deploy(ops_test: OpsTest, mimir_charm: str):
    ...
    await asyncio.gather(
        ...
        ops_test.model.deploy("prometheus-k8s", "prometheus", channel="1/edge", trust=True),
        ops_test.model.deploy("loki-k8s", "loki", channel="1/edge", trust=True),
        ops_test.model.deploy("grafana-k8s", "grafana", channel="1/edge", trust=True),
        ops_test.model.deploy("grafana-agent-k8s", "agent", channel="1/edge", series="jammy"),
